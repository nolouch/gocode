...
func (t *TodoReadTool) Description() string {
	return "Read the current task/todo list from .gocode/todo.md."
}
...
func (t *TodoWriteTool) Description() string {
	return "Overwrite the task/todo list in .gocode/todo.md. Use markdown checkboxes: '- [ ] task' and '- [x] done'."
}
